  ...
  return (
    <div style={{ display: "flex", flex: 1, overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", borderRight: isMobile ? "none" : "1px solid #F5F0E115" }}>
        ...
        {/* Product Grid */}
        <div style={{ flex: 1, overflow: "auto", padding: 12, display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(auto-fill, minmax(200px, 1fr))", gap: isMobile ? 8 : 12, alignContent: "start" }}>
          {products.map(p => (
        ...
        {/* Variant Selector */}
        {selectedProduct && (
          <div style={{ borderTop: "2px solid #C9A227", background: "linear-gradient(180deg, #1A472A, #0D1B0F)", padding: isMobile ? 12 : 16, animation: "fadeIn 0.2s ease", maxHeight: "45vh", overflow: "auto" }}>
